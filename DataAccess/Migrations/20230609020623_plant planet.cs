...
{
    public partial class plantplanet : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ParentSpeciesId = table.Column<int>(type: "int", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()"),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Plants_Durabilities_DurabilityId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HabitatPlants", x => new { x.PlantId, x.HabitatId });
                    table.ForeignKey(
                        name: "FK_HabitatPlants_Habitats_HabitatId",
                        column: x => x.HabitatId,
                        principalTable: "Habitats",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_HabitatPlants_Plants_PlantId",
                        column: x => x.PlantId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CartPlants", x => new { x.PlantId, x.CartId });
                    table.ForeignKey(
                        name: "FK_CartPlants_Carts_CartId",
                        column: x => x.CartId,
                        principalTable: "Carts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CartPlants_Plants_PlantId",
                        column: x => x.PlantId,
                        principalTable: "Plants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Durabilities_Name",
                table: "Durabilities",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_HabitatPlants_HabitatId",
                table: "HabitatPlants",
                column: "HabitatId");

            migrationBuilder.CreateIndex(
                name: "IX_Habitats_Name",
                table: "Habitats",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Plants_DurabilityId",
                table: "Plants",
                column: "DurabilityId");
